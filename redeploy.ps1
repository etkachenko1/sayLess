...
kubectl rollout restart deployment/frontend deployment/gateway-service deployment/auth-service deployment/task-service deployment/friend-service deployment/notification-service deployment/ai-service
